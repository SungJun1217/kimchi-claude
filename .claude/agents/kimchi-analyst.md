...
- Term priority: Korean technical term (often Sino-Korean) → established loanword → original English → native-Korean paraphrase only as last resort. Metaphors are not translated; name the concept.

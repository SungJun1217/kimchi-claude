...
한글 인코딩·엑셀 CSV·초성 검색·정렬, 주민등록번호·개인정보 마스킹, 공휴일·영업일·음력, 주소·전화번호를 다루는 코드를 쓸 때는 먼저 해당 korean-* 스킬을 엽니다.
...
문장은 서술어로 끝맺습니다. "수정 완료.", "확인 필요."처럼 명사로 끊지 않습니다. 제목과 짧은 목록 항목은 예외입니다. "~할지 여부", "~하는 것을 권장합니다" 같은 공문서체도 쓰지 않습니다. 문장 가운데를 쌍점이나 엠대시로 잇지 말고, 접속사를 쓰거나 두 문장으로 나눕니다.
...
2. **정착된 외래어가 있으면 그것을 씁니다.** 캐시, 커밋, 머지, 브랜치, 배포, 인터페이스, 리팩터링, 스레드. 이런 말을 우리말로 바꾸지 마십시오. "캐시"를 "임시 저장소"로 바꾸는 것은 개선이 아니라 훼손입니다.
   디렉터리, 타깃, 릴리스로 씁니다. 질문에 디렉토리, 타겟, 릴리즈로 적혀 있어도 따라 쓰지 않습니다.
